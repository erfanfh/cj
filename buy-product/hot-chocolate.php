...
$result = $conn->prepare("SELECT * FROM cart WHERE product_id = '103' && user_id = ? && status = '0' ");
...
<body>
    ...
    <section id="buy-container">
        <section class="rightBar">
            <div class="column1" style="background-image: url(Images/hot_chocolate.jpg);">
            </div>
            <div class="column2">
                <div>
                    <h3>هات چاکلت</h3>
                    <p>محتویات : شکلات آب شده + شیر + شکر</p>
                    <div class="description">
                        <p>
                        هات چاکلت چیست؟ هات‌چاکلت یا شکلات داغ، یکی از اون نوشیدنی‌های وسوسه کننده ست که محاله اگر
                        بهتون تعارف کنن، ردش کنین. هات‌چاکلت یه نوشیدنی گرمه، که از شکلات رنده شده، شکلات ذوب‌شده یا پودر کاکائو،
                        شیر گرم یا آب و احتمالاً اگر علاقه‌مند به شیرینی  طعم اون باشین، قدری شکر ساخته‌شده.
                        </p>
                    </div>
                    <div class="star">
                        <p>امتیاز : </p>
                    ...
                    if (isset($_SESSION['member_logged_in'])) {
                        if ($product_num != 0) {
                            echo '<p>قیمت نهایی: <span>' . $product_num * 70 . ' هزار تومن</span></p>';
                        } else {
            ...
            <div class="column3">
                <form method="post" action="add-product.php?product_id=103" class="buy-product">
                    <div>
