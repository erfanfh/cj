...
$result = $conn->prepare("SELECT * FROM cart WHERE product_id = '101' && user_id = ? && status = '0' ");
...
<body>
    ...
    <section id="buy-container">
        <section class="rightBar">
            <div class="column1" style="background-image: url(Images/espresso_2.jpg);">
            </div>
            <div class="column2">
                <div>
                    <h3>اسپرسو (دبل)</h3>
                    <p>محتویات : قهوه اسپرسو</p>
                    <div class="description">
                        <p>
                            این قهوه مزه تلخی داشته و مناسب همه سلیقه ها نیست. این قهوه به دو صروت ساده و دبل تهیه میشود که در اسپرسو ساده یک شات دانه قهوه اساره گیری میشود اما در قهوه دبل از دو شات دانه قهوه اساره گیری میشود. توجه کنید که میزان قهو در هر دو یکسان است.
                        </p>
                    </div>
                    <div class="star">
                        <p>امتیاز : </p>
                    ...
                    if (isset($_SESSION['member_logged_in'])) {
                        if ($product_num != 0) {
                            echo '<p>قیمت نهایی: <span>' . $product_num * 55 . ' هزار تومن</span></p>';
                        } else {
            ...
            <div class="column3">
                <form method="post" action="add-product.php?product_id=101" class="buy-product">
                    <div>
