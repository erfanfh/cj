...
$result = $conn->prepare("SELECT * FROM cart WHERE product_id = '100' && user_id = ? && status = '0' ");
...
<body>
    ...
    <section id="buy-container">
        <section class="rightBar">
            <div class="column1" style="background-image: url(Images/espresso.webp);">
            </div>
            <div class="column2">
                <div>
                    <h3>اسپرسو (ساده)</h3>
            ...
            <div class="column3">
                <form method="post" action="add-product.php?product_id=100" class="buy-product">
                    <div>
