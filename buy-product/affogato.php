...
$result = $conn->prepare("SELECT * FROM cart WHERE product_id = '106' && user_id = ? && status = '0' ");
...
<body>
    ...
    <section id="buy-container">
        <section class="rightBar">
            <div class="column1" style="background-image: url(Images/affogato_coffee.jpg);">
            </div>
            <div class="column2">
                <div>
                    <h3>آفوگاتو</h3>
                    <p>محتویات : یک اسکوپ بستنی + یک شات اسپرسو</p>
                    <div class="description">
                        <p>
                        آفوگاتو در زبان ایتالیایی بهترین
                        معنی «غرق شده» است و به یک نوع دسر ایتالیایی با پایه قهوه گفته می‌شود که از
                        یک یا دو اسکوپ بستنی وانیلی یا جلاتو و یک
                        شات قهوه اسپرسوی داغ تشکیل می‌شود. حسن این نوشیدنی/ دسر علاوه بر ظاهر جذاب و هوس‌ بر‌انگیز آن
                        طعم شیرین بستنی است که وقتی با تلخی اسپرسو ترکیب می‌شود تلطیف شده و ترکیب جذابی درست می‌کند.
                        </p>
                    </div>
                    <div class="star">
                        <p>امتیاز : </p>
                    ...
                    if (isset($_SESSION['member_logged_in'])) {
                        if ($product_num != 0) {
                            echo '<p>قیمت نهایی: <span>' . $product_num * 80 . ' هزار تومن</span></p>';
                        } else {
            ...
            <div class="column3">
                <form method="post" action="add-product.php?product_id=106" class="buy-product">
                    <div>
