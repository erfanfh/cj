...
$result = $conn->prepare("SELECT * FROM cart WHERE product_id = '108' && user_id = ? && status = '0' ");
        ...
        <section class="rightBar">
            ...
            <div class="column2">
                <div>
                    ...
                    <p>محتویات : قهوه اسپرسو + شیر + سیروپ کارامل</p>
                    <div class="description">
                        <p>
                        اگر طعم تلخ قهوه را نمی پسندید و دنبال نوشیدنی بر پایه قهوه با طعم ملایم
                        و شیرین هستید کارامل ماکیاتو یکی از بهترین انتخاب هایی است که می توانید انجام دهید.
                        ماکیاتو نوشیدنی بر پایه ترکیب اسپرسو 
                        و شیر است. در حقیقت کلمه ماکیاتو در زبان 
                        ایتالیایی به معنای “لکه دار” است. زمانی که میزان شیر در روی اسپرسو به قدری 
                        کم باشد که مانند لکه ای رو اسپرسو دیده شود به آن ماکیاتو گفته می شود. 
                        کارامل ماکیاتو که ابتدا توسط شرکت استار باکس تولید شد تفاوت زیادی با ماکیاتو خالی دارد و طعم بهتری هم دارد
                        </p>
                    </div>
                    <div class="star">
                        <p>امتیاز : </p>
            ...
            <div class="column3">
                <form method="post" action="add-product.php?product_id=108" class="buy-product">
                    <div>
