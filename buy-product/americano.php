...
$result = $conn->prepare("SELECT * FROM cart WHERE product_id = '109' && user_id = ? && status = '0' ");
...
<body>
    ...
    <section id="buy-container">
        <section class="rightBar">
            <div class="column1" style="background-image: url(Images/americano_coffee.jpg);">
            </div>
            <div class="column2">
                <div>
                    <h3>آمریکانو</h3>
                    <p>محتویات : آب داغ + اسپرسو</p>
                    <div class="description">
                        <p>
                        این قهوه با اضافه کردن آب داغ به اسپرسو درست می شود. آب، کمی اسپرسو را تضعیف می کند
                        ، حجم قهوه ی بیشتری به شما می دهد، اما با طعم اسپرسو.
                        این قهوه مناسب افرادی است که مزه تلخ اسپرسو خوشایند آنها نیست. این قهوه حجم بیشتری نسبت به اسپرسو دارد.
                        </p>
                    </div>
                    <div class="star">
                        <p>امتیاز : </p>
            ...
            <div class="column3">
                <form method="post" action="add-product.php?product_id=109" class="buy-product">
                    <div>
