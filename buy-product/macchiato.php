...
$result = $conn->prepare("SELECT * FROM cart WHERE product_id = '107' && user_id = ? && status = '0' ");
...
<body>
    ...
    <section id="buy-container">
        <section class="rightBar">
            <div class="column1" style="background-image: url(Images/macchiato.webp);">
            </div>
            <div class="column2">
                <div>
                    <h3>ماکیاتو</h3>
                    ...
                    <div class="description">
                        <p>
                        ماکیاتو قهوه‌ای غلیظ، کم حجم و تلخه که نسبت به اسپرسو طعم ملایم‌تری داره.
                        در زبان ایتالیایی کافه
                        به‌معنای قهوه و ماکیاتو به‌معنای «خال‌خال»، «نشان‌دار» یا «لکه‌دار» شده‌است 
                        و در این نوشیدنی، اشاره به مقدار خیلی کم شیری دارد که پس از آماده‌سازی به
                        صورت کف، در حد یک یا دو قاشق غذاخوری بر روی یک فنجان اسپرسوی داغ گذاشته
                        می‌شود و آن را نشان‌دار می‌کند. لذا کافه ماکیاتو یعنی اسپرسوی لکه دار
                        </p>
            ...
            <div class="column3">
                <form method="post" action="add-product.php?product_id=107" class="buy-product">
                    <div>
