...
$result = $conn->prepare("SELECT * FROM cart WHERE product_id = '104' && user_id = ? && status = '0' ");
...
<body>
    ...
    <section id="buy-container">
        <section class="rightBar">
            <div class="column1" style="background-image: url(Images/mocha.jpg);">
            </div>
            <div class="column2">
                <div>
                    <h3>موکا</h3>
                    ...
                    <div class="description">
                        <p>
                        قهوه موکا یا کافه موکا نام های این نوشیدنی بر 
                        پایه اسپرسو هستند که جزو قهوه های گرم محسوب می شوند که البته می توان آن را به صورت 
                        سرد نیز سرو کرد. به این قهوه موکاچینو (به زبان ایتالیایی) نیز گفته 
                        می شود که دلیل این نامگذاری شبیه بودن آن به نوشیدنی کاپوچینو می باشد.
                        </p>
            ...
            <div class="column3">
                <form method="post" action="add-product.php?product_id=104" class="buy-product">
                    <div>
