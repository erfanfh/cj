...
$result = $conn->prepare("SELECT * FROM cart WHERE product_id = '105' && user_id = ? && status = '0' ");
...
<body>
    ...
    <section id="buy-container">
        <section class="rightBar">
            <div class="column1" style="background-image: url(Images/latte.webp);">
            </div>
            <div class="column2">
                <div>
                    <h3>لاته</h3>
                    <p>محتویات : قهوه اسپرسو + شیر + فوم شیر</p>
                    <div class="description">
                        <p>
                        کافه لاته یا لاته، ترکیب بسیار جذاب و عالی شیر و اسپرسو است، 
                        لاته به نوعی توسعه یافته کاپوچینو است،
                        در واقع کاپوچینو و لاته گویی خواهر و برادر بی نظیر دنیای قهوه هستند،
                        کافه لاته از عبارت ایتالیایی Caffe latte آمده که به معنی قهوه (caffe) و شیر (latte)
                        است. کافه لاته ترکیبی از اسپرسو و شیر داغ با مقدار 
                        زیادی فوم شیر است و شامل طرح‌های هنری خاصی می شود که به آن در اصطلاح لاته آرت گفته می شود.
                        </p>
                    ...
                    if (isset($_SESSION['member_logged_in'])) {
                        if ($product_num != 0) {
                            echo '<p>قیمت نهایی: <span>' . $product_num * 65 . ' هزار تومن</span></p>';
                        } else {
            ...
            <div class="column3">
                <form method="post" action="add-product.php?product_id=105" class="buy-product">
                    <div>
